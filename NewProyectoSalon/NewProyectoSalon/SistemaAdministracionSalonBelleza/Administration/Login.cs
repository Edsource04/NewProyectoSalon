...
namespace SistemaAdministracionSalonBelleza.AdministradorAplication
{
    public partial class Login : Form
    {
        ...
        private void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            {
                VerificationLogin(txtuser.Text.Trim(), txtpass.Text.Trim());
            }
             
        }


        private void VerificationLogin(string usu,string clave)
        { 
             ...
             if (p.Usuario != usu)
            {
                ...
                else if(clave == Utility.Decrypt_Query(p.Clave) && p.Usuario == usu)
                {
                    ...
                    AdministradorAplication.Loading mp = new AdministradorAplication.Loading();
                    mp.Show();
                }
            }
    }
